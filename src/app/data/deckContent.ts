...
export const slideMeta: SlideMeta[] = [
  ...
  },
  {
    ...
    title: 'Доход формируется за счёт правильной организации пространства',
    subtitle:
      'Каждая зона встроена в свою роль: массовый поток, высокий чек, регулярные платежи или дополнительные продажи.',
    backdrop: 'stone',
  ...
  },
  {
    id: 7,
    key: 'monthly-revenue',
    eyebrow: 'МЕСЯЧНАЯ ВЫРУЧКА',
    title: 'Месячная выручка строится на девяти потоках',
    subtitle:
      'Ставка делается не на чистый спорт, а на микс из подписок, мероприятий и сопутствующих услуг.',
    backdrop: 'copper',
  ...
  },
  {
    ...
    title: 'Каждая зона имеет свою цену, загрузку и роль',
    subtitle: 'Доход формируется не из одного корта, а из комбинации ролей.',
    backdrop: 'blueprint',
  ...
  },
  {
    ...
    key: 'scheduling',
    eyebrow: 'РАСПИСАНИЕ',
    title: 'Расписание — главный инструмент доходности',
    subtitle: 'День разделён на окна с разной экономикой и типом загрузки',
    backdrop: 'stone',
  ...
  },
  {
    ...
    title: 'Рост обеспечивается загрузкой и плотностью календаря',
    subtitle:
      'Первый год формирует базу, второй — усиливает вечернюю загрузку, третий — повышает плотность турниров и дорогих слотов',
    backdrop: 'blueprint',
  ...
  },
  {
    id: 11,
    key: 'returns',
    eyebrow: 'ЛОГИКА ВОЗВРАТА',
    title: 'Возврат капитала строится на управляемой загрузке, а не на ажиотаже',
    subtitle:
      'Срок возврата и доходность формируются за счёт стабильной базы, вечерней загрузки и турнирной модели',
    backdrop: 'copper',
  ...
  },
  {
    id: 12,
    key: 'drivers',
    eyebrow: 'СТРАТЕГИЧЕСКИЙ ФРЕЙМ',
    title: 'Четыре механизма делают модель устойчивой',
    subtitle:
      'Выручка формируется не одним источником, а системой взаимодополняющих потоков',
    backdrop: 'charcoal',
  ...
  },
  {
    ...
    title: 'Новая категория, а не ещё один зал',
    subtitle:
      'APEX ARENA объединяет академию, лиги, турниры, тренажёрный зал и клиентскую среду в одной системе, а не продаёт только доступ к площадке',
    backdrop: 'blueprint',
  ...
  },
  {
    id: 14,
    key: 'ask',
    eyebrow: 'ИНВЕСТИЦИОННЫЙ ЗАПРОС',
    title: 'Инвестиционный запрос уже структурирован',
    subtitle:
      'Капитал распределён по логике запуска первого флагманского объекта, а не как открытый перечень затрат',
    backdrop: 'stone',
  ...
  },
  {
    ...
    key: 'scalability',
    eyebrow: 'ЛОГИКА СЕТИ',
    title: 'Флагман нужен как модель для сети',
    subtitle:
      'Первый объект подтверждает планировку, календарную логику, стандарты сервиса и коммерческую модель, которые затем можно переносить в новые локации',
    backdrop: 'copper',
    ctaLabel: 'Логика сети',
    deepDiveId: 'scalability-playbook',
    ctaHint: 'Как первый объект превращается в модель для запуска следующих локаций.',
  },
  {
    id: 16,
    key: 'closing',
    eyebrow: 'ГОТОВАЯ МОДЕЛЬ',
    title: 'Готовая инвестиционная модель для запуска и масштабирования',
    subtitle: '',
    backdrop: 'arena',
    ctaLabel: 'Открыть пакет',
    deepDiveId: 'closing-package',
    ctaHint: 'Консолидированный доступ к ключевым материалам проекта.',
  },
];
